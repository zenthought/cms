...
class Video(models.Model):
    av_type = models.CharField(choices=(
        ...
        ('1', '职场窍门'),
        ('2', 'IT百科')
    ))  # 公开课 职场窍门   IT百科     # 	av-type 视频分类 用于自学课程页面
    study_num = models.IntegerField(max_length=32)  # 学习人数
...
class Book(models.Model):
    ...
    book_type = models.CharField(choices=((0, '跟老男孩学linux'), (1, '跟老男孩学python')), )
    ...
    book_page_num = models.IntegerField(max_length=32)  # 页数
...
class classmate_resource(models.Model):
    ...
    type = models.CharField(choices=(
        ...
        (2, '笔记'),
        (3, '视频'),
    ))  # choices类型  commont评价  offer  note笔记  video


class Job(models.Model):
    # 招聘表   页面底部--加入我们
    name = models.CharField(max_length=32)  # 职位名称
    type = models.CharField(choices=((0, 'python讲师'), (1, 'linux讲师')))  # 职位分类
